...
import { Flower2, Sun, Cloud, Droplet } from 'lucide-react';

const fragrances = [
  {
    name: 'Rose Elixir',
    description: 'A luxurious blend of Damascus rose and precious florals',
    price: 269,
    image: 'https://images.pexels.com/photos/3059609/pexels-photo-3059609.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Damascus Rose', 'Peony', 'White Musk', 'Amber']
  },
  {
    name: 'Jasmine Dreams',
    description: 'Pure jasmine blended with exotic white flowers',
    price: 259,
    image: 'https://images.pexels.com/photos/5632397/pexels-photo-5632397.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Jasmine', 'Tuberose', 'Orange Blossom', 'Vanilla']
  },
  {
    name: 'Lily Valley',
    description: 'Fresh lily of the valley with green notes',
    price: 249,
    image: 'https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Lily of the Valley', 'Green Notes', 'Jasmine', 'Musk']
  },
  {
    name: 'Iris Royale',
    description: 'Noble iris combined with powdery notes',
    price: 279,
    image: 'https://images.pexels.com/photos/4110409/pexels-photo-4110409.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Iris', 'Violet', 'Powder Notes', 'Woody Notes']
  }
];
...
const features = [
  ...
  },
  {
    ...
    description: 'Preserving the true essence of each flower'
  },
  {
    icon: Cloud,
    title: 'Long-Lasting',
    description: 'Fragrances that evolve beautifully throughout the day'
  },
  {
    icon: Droplet,
    title: 'Pure Ingredients',
    description: 'Made with the highest quality natural extracts'
  }
];
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl px-4">
          ...
          >
            Experience the delicate beauty of nature's finest blooms
          </motion.p>
        </div>
      </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-light mb-6">The Language of Flowers</h2>
        <p className="text-gray-600">
          Our Floral collection captures the ethereal beauty and delicate essence of the world's most precious flowers. 
          Each fragrance tells a unique story, bringing to life the romance and sophistication of natural blooms 
          through masterful perfumery.
        </p>
      </div>

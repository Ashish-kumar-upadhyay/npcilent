...
import { Sun, Sparkles, Wind, Droplet } from 'lucide-react';

const fragrances = [
  {
    name: 'Mediterranean Breeze',
    description: 'Fresh citrus with Mediterranean herbs',
    price: 239,
    image: 'https://images.pexels.com/photos/3059609/pexels-photo-3059609.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Bergamot', 'Lemon', 'Rosemary', 'Sea Salt']
  },
  {
    name: 'Citrus Grove',
    description: 'A blend of sun-ripened citrus fruits',
    price: 249,
    image: 'https://images.pexels.com/photos/5632397/pexels-photo-5632397.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Orange', 'Grapefruit', 'Mandarin', 'Neroli']
  },
  {
    name: 'Fresh Verbena',
    description: 'Zesty lemon verbena with green notes',
    price: 229,
    image: 'https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Verbena', 'Lime', 'Green Tea', 'White Musk']
  },
  {
    name: 'Citrus & Woods',
    description: 'Bright citrus balanced with warm woods',
    price: 259,
    image: 'https://images.pexels.com/photos/4110409/pexels-photo-4110409.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    notes: ['Yuzu', 'Cedar', 'Vetiver', 'Bergamot']
  }
];
...
const features = [
  {
    icon: Sun,
    title: 'Energizing',
    description: 'Invigorating scents to uplift your mood'
  },
  {
    icon: Sparkles,
    title: 'Fresh & Clean',
    description: 'Pure and refreshing fragrances'
  },
  {
    icon: Wind,
    title: 'Light & Airy',
  ...
  },
  {
    icon: Droplet,
    title: 'Natural',
    description: 'Made with pure citrus essences'
  }
];
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl px-4">
          ...
          >
            Fresh and invigorating scents inspired by sun-kissed citrus groves
          </motion.p>
        </div>
      </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-light mb-6">The Essence of Freshness</h2>
        <p className="text-gray-600">
          Our Citrus collection brings together the most vibrant and energizing notes from 
          nature's citrus groves. Each fragrance captures the pure, refreshing essence of 
          sun-ripened citrus fruits, creating an uplifting and invigorating experience.
        </p>
      </div>
